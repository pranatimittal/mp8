...
<?php
 ...
 $q=mysqli_query($con,"SELECT * FROM faculty WHERE did='$did'" )or die('Error231');
 ...
 while($row=mysqli_fetch_array($q))
      {
		...
		//  echo $email;
		   ...
		   $quer=mysqli_query($con,"SELECT * FROM login_faculty WHERE id='$fid'" )or die('Error23');
...
echo'<div class="table-users">
   ...
   <table cellspacing="0">
      <tr>
         <th>Designation</th>
         <td>'.$d.'</td>
         <td rowspan="5" style="background-color:white;border-left: 1px solid #398B93;text-align:center;width:20%;"><img class="fac_img" src="../faculty_pages/profile_pic/'.$img.'" alt="" /><br><a href="profile.php?id='.$fid.'&img='.$img.'">View Detailed Profile</a></td>
      </tr>
      <tr>
         <th>Qualification</th>
    ...
    ?>
      <button class="button button1" onclick="location.href ='index.php';"><b>Go back to list of departments</b></button>
</div> 
