...
<?php
   ...
   $query ="SELECT * FROM f_current_funding where fid='$fid'";
   ...
   while($row = mysqli_fetch_array($result)) {
	   ...
	   ?>
      <tr>
      <li><?php echo $row['current_project']; ?></li>
...
<div class="box1">
<h2>Successfully Completed Projects</h2>
<ul>
<?php
   
   $query ="SELECT * FROM f_complete_funding where fid='$fid'";
   ...
   while($row = mysqli_fetch_array($result)) {
	   ...
	   ?>
      <tr>
      <li><?php echo $row['completed_project']; ?></li>
...
<?php
   ...
   $query ="SELECT * FROM f_cons_ass_funding where fid='$fid'";
...
<div class="box4">
<h2>Equipment Grants</h2>
<ul>
<?php
   
   $query ="SELECT * FROM f_equipment_funding where fid='$fid'";
   ...
   while($row = mysqli_fetch_array($result)) {
	   ...
	   ?>
      <tr>
      <li><?php echo $row['equipment_grant']; ?></li>
