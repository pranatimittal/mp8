...
$q1 =mysqli_query($con,"SELECT sec_ques,sques_ans FROM login_faculty WHERE email='$e'")or die('Error1');
...
<div class="limiter">
    <div class="container-login100">
      ...
      {
        $ans1= $_POST["ans"];
        $query= mysqli_query($con,"SELECT sques_ans FROM login_faculty WHERE email='$e'");
