...
<a name="top"></a>
  ...
  <div class="navbar">
    ...
    <a href="fac_classroom_page.php"><i class="fa fa-user  fa-home"></i> Home</a><a href="fac_upload_learning.php"><i class="fa fa-upload" aria-hidden="true"></i> Upload Learning Resources </a> 
  ...
  <div class="main">
      <h1>RESOURCES MODULE</h1>
        <div class = "adminpanel">
          ...
          <p>You can upload and manage learning resources here</p>
        </div>
      </div>
