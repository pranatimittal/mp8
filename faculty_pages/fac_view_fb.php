...
<a name="top"></a>
  ...
  <div class="main">
        <h1>VIEW ALL FEEDBACKS GIVEN BY YOU</h1>
        </div>
         <br>
  ...
  $result = mysqli_query($con,"SELECT f_name,f_subject, date FROM teacher_fb WHERE fac_id='$id' GROUP BY f_subject,date ORDER BY date DESC") or die('Error');
...
while($row = mysqli_fetch_array($result)) {
  ...
  <td><a title="View" href="fac_view_fb1.php?s='.$subj.'&d='.$d.'&fn='.$fn.'"><i>View Feedback</i></a></td></tr>';
