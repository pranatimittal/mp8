...
<?php
  ...
  $id=$_SESSION["idf"];
  $result = mysqli_query($con,"SELECT program,branch,semester FROM coursedetails WHERE tid='$id' ") or die('Error');
$c=1;
...
while($row = mysqli_fetch_array($result)) {
  ...
  echo '<tr><td>'.$c++.'</td><td>'.$p.'</td><td>'.$b.'</td><td>'.$s.'</td><td><a title="Click here to view list of registered students." href="studentlist.php?pp='.$p.'&bb='.$b.'&ss='.$s.'"><i>View</i></a></td></tr>';
}
$c=0;
echo '</table></div>';
