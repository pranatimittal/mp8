...
<br>
<div style="font-size:20px;margin-left:40%;"><b>Question number: <?php echo $m; ?><br /></div>
<br><br>
...
?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
echo '<input style="float:left; margin-top:30px; margin-left:20px;padding:left;"type="file" name="image'.$m.'" ><br';
?>
  </div/>
</div>
<br><br><br><br><br>
...
<?php echo '<select id="ans'.$m.'" name="ans'.$m.'" placeholder="Choose correct answer " class="form-control input-md" >
 ...
 <br><br>
  ...
  <div class="col-md-12"> 
   <button type="addmore" class="registerbtn" name="add" style="margin-left:26%;float: left;"><i class="fa fa-plus" aria-hidden="true" ></i> Submit and Click to add more questions</button>
   <br>
   <br>
    <input name="sub" type="submit" style="margin-left:26%; float: left;" class="btn btn-primary" value="Submit and Return" class="btn btn-primary"/>
