...
<div class = "manageuser">
  ...
  $sno=1;
    ...
    $sql1 = mysqli_query($con,"SELECT * FROM history AS h INNER JOIN login_student AS s ON h.email=s.email WHERE h.quizid='$tid' ORDER BY h.score DESC
");
...
echo '<div align="center">
    <button class="btn"><i class="fa fa-download"></i><a style= "color : white ;" href="export.php?tid='.$tid.'"><u><b> Export To Excel </b></u></a></button>
    </div>';
// echo '<a href="export.php?tid='.$tid.'"> Export To Excel </a>
// ';
?>
