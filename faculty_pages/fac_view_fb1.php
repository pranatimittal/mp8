...
<a name="top"></a>
  ...
  <div class="main">
        ...
        <div class = "manageuser">
          ...
          $result = mysqli_query($con,"SELECT AVG(teaching_skill),AVG(presentation_skills), AVG(personal_attributes), AVG(Qoflecture),AVG(practical_section),AVG(beyond_class),AVG(gq1),AVG(gq2) FROM teacher_fb WHERE fac_id='$id' AND f_subject='$s' AND date='$d'") or die('Error');
          ...
          // echo '</div><div>
          //        <button><a href="graph.php?s='.$s.'&d='.$d.'">Visualize</a></button>
          //      </div>';
