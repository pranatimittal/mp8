...
<div class = "manageuser">
  ...
  //rno="";
  //$n="";
    $sql1 = mysqli_query($con,"SELECT * FROM rank  ORDER BY score DESC");
...
//echo $e;
      ...
      $sql2=mysqli_query($con,"SELECT * FROM login_student WHERE email='$e' " )or die('Error231');
      ...
      while($row1=mysqli_fetch_array($sql2) )
      {
       ...
       // echo $rno;
        $sno++;
        echo '<tr><td>'.$sno.'</td><td>'.$rno.'</td><td>'.$n.'</td><td>'.$s.'</td></tr>';
      }
