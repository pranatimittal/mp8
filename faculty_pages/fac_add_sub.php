        ...
        <div class="card card-5">
            ...
            <div class="card-body">
              ...
              <select id="subcode" name="subjcode" required>
                ...
                <option value="MCS 516">MCS 104</option>
              </select>
              <hr>
...
if(isset($_POST["sub"]) or isset($_POST["add"]))
{
  ...
  $query = "INSERT INTO subject VALUES ('', '$sc', '$sn', '$tid', '$tn')";
  $row= mysqli_query($con,$query);

    if($row > 0)
    {
    echo "<script>alert('Subjects successfully registerd.');</script>";
    }
    else
    {
  ...
  $query1 = "INSERT INTO coursedetails VALUES ('$p', '$b', '$sem', '$tid')";
