...
<link rel = "icon" type = "image/png" href = "IGDTUW_logo.png">
    ...
    <div class="container-login100">
        <div class="wrap-login100">
            <div class="login100-pic js-tilt" data-tilt>
                <img src="IGDTUW_logo.png" alt="IGDTUW">
            </div>
            ...
            <form class="login100-form validate-form" action="" method="post">
                ...
                <div class="container-login100-form-btn">
                 ...
                 <span class="login100-form-title">
                   ...
                   <h7> <a href="faculty_register.php"> Click here to register!</a></h7>
                </span>
...
if(isset($_POST["sub"]))
{
  ...
  $p= $_POST["pwd"];
     ...
     $_SESSION["xy"]=$e;
       $_SESSION["yz"]=$p;
    $query= "select * from login_faculty where email='$e' and password='$p'";
    ...
    $i= $test['id'];
      ...
      echo "<script>window.location.href='fac_module.php'</script>";
