...
<?php
  ...
  while($row = mysqli_fetch_array($result1)) {
   ...
   $img= $row['image'];
    ...
    echo '<br><img src="profile_pic/'.$img.'" alt="xyz" style="width:50%">';
  ...
  while($row = mysqli_fetch_array($result2)) {
    ...
    $b=$row['branch'];
    $sno++;
    echo '<tr><td>'.$sno.'</td><td>'.$p.'</td><td>'.$b.'</td><td><a title="Delete User" href="#"><i>Delete</i></a></td></tr>';
   }
...
<div class="content">
  ...
  while($row = mysqli_fetch_array($result3)) {
    ...
    $sc=$row['subjcode'];
    $sno++;
    echo '<tr><td>'.$sno.'</td><td>'.$sc.'</td><td>'.$sn.'</td><td><a title="Delete User" href="#"><i>Delete</i></a></td></tr>';
   }   
...
<br>
<button class="button button1" onclick="location.href = 'fac_profile.php';"><b>Submit</b></button>
<?php
