    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b>TECHNOLOGIES SUCCESSFULLY DEVELOPED AND TRANSFERRED</b>
            </span>

            <div class="wrap-input1 validate-input">
                <input class="input1" type="text" name="techname" placeholder="Enter name of the technology">
                <span class="shadow-input1"></span>
            </div>

            <div class="wrap-input1 validate-input" data-validate = "Message is required">
                <textarea class="input1" name="developers" placeholder="Enter lead developers . . . . ."></textarea>
                <span class="shadow-input1"></span>
            </div>

            <div class="wrap-input1 validate-input" data-validate = "Message is required">
                <textarea class="input1" name="desc" placeholder="Enter description . . . . . ."></textarea>
                <span class="shadow-input1"></span>
            </div>
            ...
            <br>
            <div class="container-contact1-form-btn">
                <button class="contact1-form-btn" name="addmore">
                    <span>
