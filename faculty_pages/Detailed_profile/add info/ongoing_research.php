    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b><i class="fa fa-plus"></i> Add ongoing research papers</b>
            </span>


            <div class="wrap-input1 validate-input" data-validate = "Message is required">
                <textarea class="input1" name="msg" placeholder="Enter Here !!!"></textarea>
...
if(isset($_POST["sub"]) or isset($_POST["add"]))
{
  ...
  $query = "INSERT INTO ongoing_research VALUES ('', '$tid','$m')";
  $row= mysqli_query($con,$query);

    if($row > 0)
    {
    echo "<script>alert(' Ongoing Research successfully added.');</script>";
    }
    else
    {
  ...
  {
    echo "<script>window.location.href='ongoing_research.php'</script>";
  }
