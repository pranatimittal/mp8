    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b> Enter your research publications</b>
            </span>
            ...
            <div class="wrap-input1 validate-input" data-validate = "Message is required">
                <textarea class="input1" name="pname" placeholder="Enter publication name !!!"></textarea>
                <span class="shadow-input1"></span>
            </div>
...
if(isset($_POST["sub"]) or isset($_POST["add"]))
{
  ...
  $query = "INSERT INTO f_research VALUES ('', '$tid', '$y', '$n', '$l')";
  $row= mysqli_query($con,$query);

    if($row > 0)
    {
    echo "<script>alert('Research Publication successfully added.');</script>";
    }
    else
    {
  ...
  {
    echo "<script>window.location.href='research_publications.php'</script>";
  }
