...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
    <div class="wrapper wrapper--w790">
        <div class="card card-5">
            <div class="card-heading">
                <h2 class="title">ENTER BOOK PUBLICATIONS HERE <i class="fa fa-book" aria-hidden="true"></i></h2>
            </div>
            <div class="card-body">
  ...
  <label for="bp"><b>Book publised</b></label>
   ...
   <input type="text" id="bp" name="bp" placeholder="Enter book published" required>
...
if(isset($_POST["sub"]) or isset($_POST["add"]))
{
  ...
  $query = "INSERT INTO f_books VALUES ('', '$tid', '$year', '$bp', '$publisher', '$author', '$isbn', '$link')";
  $row= mysqli_query($con,$query);

    if($row > 0)
    {
    echo "<script>alert('Book publications successfully added.');</script>";
    }
    else
    {
  ...
  {
    echo "<script>window.location.href='book_publications.php'</script>";
  }
