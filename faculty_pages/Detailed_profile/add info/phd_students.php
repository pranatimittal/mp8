...
if(isset($_POST["sub"]) or isset($_POST["add"]))
{
  ...
  $query = "INSERT INTO f_student VALUES ('', '$tid','PhD','$n','$t','$u','$d')";
  $row= mysqli_query($con,$query);

    if($row > 0)
    {
    echo "<script>alert(' PhD student details successfully added.');</script>";
    }
    else
    {
  ...
  {
    echo "<script>window.location.href='phd_students.php'</script>";
  }
