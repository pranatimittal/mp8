    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b> Enter conference publications</b>
            </span>

            <div class="wrap-input1 validate-input">
                <input class="input1" type="text" name="year" placeholder="Enter year of publication (in YYYY format) ">
                <span class="shadow-input1"></span>
            </div>

            <div class="wrap-input1 validate-input" data-validate = "Message is required">
                <textarea class="input1" name="paper" placeholder="Enter Paper !!!"></textarea>
                <span class="shadow-input1"></span>
            </div>

            <div class="wrap-input1 validate-input">
                <input class="input1" type="text" name="link" placeholder="Link">
                <span class="shadow-input1"></span>
            </div>
...
if(isset($_POST["sub"]) or isset($_POST["add"]))
{
  ...
  $query = "INSERT INTO f_conference VALUES ('', '$tid', '$year', '$paper', '$link')";
  $row= mysqli_query($con,$query);

    if($row > 0)
    {
    echo "<script>alert('Conference publications successfully added.');</script>";
    }
    else
    {
  ...
  {
    echo "<script>window.location.href='conference_publications.php'</script>";
  }
