...
if(isset($_POST["sub"]) or isset($_POST["add"]))
{
  ...
  $query = "INSERT INTO f_student VALUES ('', '$tid','Research','$n','$t','$u','$d')";
  $row= mysqli_query($con,$query);

    if($row > 0)
    {
    echo "<script>alert(' Research student details successfully added.');</script>";
    }
    else
    {
  ...
  {
    echo "<script>window.location.href='research_students.php'</script>";
  }
