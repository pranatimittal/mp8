    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b><i class="fa fa-plus"></i> Add achievements</b>
            </span>


            <div class="wrap-input1 validate-input" data-validate = "Message is required">
                <textarea class="input1" name="achievement" placeholder="Enter your achievements here !!!"></textarea>
...
{
  $tid=$_SESSION['idf'];
  $val= $_POST['achievement'];
  

  $query = "INSERT INTO f_achievement VALUES ('', '$tid', '$val')";
  $row= mysqli_query($con,$query);

    if($row > 0)
    {
    echo "<script>alert('Achievements successfully added.');</script>";
    }
    else
    {
  ...
  {
    echo "<script>window.location.href='achievements.php'</script>";
  }
