...
<title>Research Students Edit</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
...
if(isset($_POST["sub"]))
{
  ...
  $row= mysqli_query($con,$query)or die("error9342");
    ...
    if($row > 0)
    {
    echo "<script>alert('Research Student details successfully edited.');</script>";
    echo "<script>window.location.href='research_students_edit.php'</script>";
    }
    else
    {
