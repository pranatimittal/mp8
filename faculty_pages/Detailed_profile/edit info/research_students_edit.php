...
echo '<div class="table-users">
   <div class="heading"><b>Research Scholars</b></div>
 ...
 while($row11=mysqli_fetch_array($q11))
  {
    ...
    $darr=explode("-",$d);
      ...
      echo '<tr>
         ...
         <td>'.$t.'</td>
         <td>'.$u.'</td>
         <td>'.$darr[2].'/'.$darr[1].'/'.$darr[0].'</td><td><a href="edit_research_stu_here.php?id='.$sid.'">Edit</a></td><td><a href="del_Rstu.php?id='.$sid.'">Delete</a></td></tr>';
  }
