...
<title>Equipment Grants Edit</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Equipment Grants</b>
            </span>
<?php
   
   $query ="SELECT * FROM f_equipment_funding where fid='$idf' and equip_id='$aid'";
   
   $result = mysqli_query($con,$query) or die('Error');
    $c=1;
   while($row = mysqli_fetch_array($result)) {
	   
	    $pro= $row['equipment_grant'];
   ...
   ?>
		...
		<?php
				...
				{	
					...
					$query = "UPDATE f_equipment_funding SET equipment_grant='$mes' where equip_id='$aid' and fid='$idf'";
			...
			if($roww > 0)
			{
				echo "<script>alert('Equipment Granted fundings edited successfully.')</script>";
