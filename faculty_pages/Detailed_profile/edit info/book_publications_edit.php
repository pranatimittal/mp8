...
<title>Edit Book Publications</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
...
<div class="table-users">
   <div class="heading"><b>Edit / Delete Book Publications</b></div>
   ...
   $query ="SELECT * FROM f_books where fid='$idf'";
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      <td><?php echo $c++; ?> </td>
         ...
         <td><?php echo $row['isbn']; ?></td>
		   <?php echo '<td><a href="edit_book_here.php?aid='.$aid.'">Edit</a></td>';?>
         <?php echo '<td><a href="del_book.php?aid='.$aid.'">Delete</a></td>'; ?>
