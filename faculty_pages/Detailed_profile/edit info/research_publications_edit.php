...
<title>Edit Research Publications</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
...
<div class="table-users">
   <div class="heading"><b>Edit / Delete Research Publications</b></div>
 ...
 while($row=mysqli_fetch_array($q))
  {
   ...
   echo '<tr>
      ...
      <td>'.$y.'</td>
         <td>'.$p.'</td>
         <td><a href="'.$l.'">Click Here</a></td>
         <td><a href="edit_research_pub_here.php?id='.$id.'">Edit</a></td>
         <td><a href="del_research.php?id='.$id.'">Delete</a></td>
      </tr>';
  }
