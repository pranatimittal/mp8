...
<title>Edit Conference Publications</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
...
<div class="table-users">
   <div class="heading"><b>Edit / Delete Conference Publications</b></div>
   ...
   $query ="SELECT * FROM f_conference where fid='$idf'";
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      <td><?php echo $c++; ?> </td>
         ...
         <td><a href=<?php echo $row['link']; ?><>Click Here</a></td>
		  <?php echo '<td><a href="edit_conference_here.php?aid='.$aid.'">Edit</a></td>';?>
         <?php echo '<td><a href="del_conference.php?aid='.$aid.'">Delete</a></td>'; ?>
