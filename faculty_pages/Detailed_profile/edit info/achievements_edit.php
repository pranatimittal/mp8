...
<div class="table-users">
   <div class="heading"><b>Edit / Delete Achievements</b></div>
   ...
   $query ="SELECT * FROM f_achievement where fid='$idf'";
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      <?php echo '<td><a href="edit_achievements_here.php?aid='.$aid.'">Edit</a></td>';?>
      <?php echo '<td><a href="del_achievement.php?aid='.$aid.'">Delete</a></td>'; ?>
      </tr>
