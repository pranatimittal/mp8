...
<div class="table-users">
   <div class="heading"><b>Edit / Delete Currently Funded Projects</b></div>
   
   <table cellspacing="0">
      <tr>
      <th>S.No.</th>
      <th>Currently Funded Projects</th>
         <th>Edit</th>
         <th>Delete</th>
   ...
   $query ="SELECT * FROM f_current_funding where fid='$idf'";
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      <tr>
	  <td><?php echo $c++; ?></td>
      <td><?php echo $row['current_project']; ?></td>
	  <?php echo '<td><a href="edit_curr_funded.php?aid='.$aid.'">Edit</a></td>';?>
      <?php echo '<td><a href="del_curr_fund.php?aid='.$aid.'">Delete</a></td>'; ?>
   ...
   ?>
     ...
     <br> 
<div class="table-users">
   <div class="heading" style="background-color:#48C9B0 ;"><b>Edit / Delete Successfully Completed Projects</b></div>
   
   <table cellspacing="0">
      <tr>
      <th>S.No.</th>
      <th>Successfully Completed Projects</th>
         <th>Edit</th>
         <th>Delete</th>
   ...
   $query ="SELECT * FROM f_complete_funding where fid='$idf'";
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      <tr>
	  <td><?php echo $c++; ?></td>
      <td><?php echo $row['completed_project']; ?></td>
	   <?php echo '<td><a href="edit_succ_completed.php?aid='.$aid.'">Edit</a></td>';?>
      <?php echo '<td><a href="del_com_fund.php?aid='.$aid.'">Delete</a></td>'; ?>
   ...
   ?>
      ...
      <br>
<div class="table-users">
   <div class="heading" style="background-color:#239B56 ;"><b>Edit / Delete Consulting Assignments</b></div>
   
   <table cellspacing="0">
      <tr>
      <th>S.No.</th>
      <th>Consulting Assignments</th>
         <th>Edit</th>
         <th>Delete</th>
   ...
   $query ="SELECT * FROM f_cons_ass_funding where fid='$idf'";
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      <tr>
	  <td><?php echo $c++; ?></td>
      <td><?php echo $row['cons_ass']; ?></td>
       <?php echo '<td><a href="edit_consulting_ass.php?aid='.$aid.'">Edit</a></td>';?>
      <?php echo '<td><a href="del_cons_ass_fund.php?aid='.$aid.'">Delete</a></td>'; ?>
...
<div class="table-users">
   <div class="heading" style="background-color:#5499C7   ;"><b>Edit / Delete Equipment Grants</b></div>
   
   <table cellspacing="0">
      <tr>
      <th>S.No.</th>
      <th>Equipment Grants</th>
         <th>Edit</th>
         <th>Delete</th>
   ...
   $query ="SELECT * FROM f_equipment_funding where fid='$idf'";
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      <tr>
	  <td><?php echo $c++; ?></td>
      <td><?php echo $row['equipment_grant']; ?></td>
	  <?php echo '<td><a href="edit_equip_grants.php?aid='.$aid.'">Edit</a></td>';?>
      <?php echo '<td><a href="del_equip_fund.php?aid='.$aid.'">Delete</a></td>'; ?>
