...
<title>Edit Ongoing Research</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
...
echo '<div class="table-users">
   <div class="heading"><b>Edit / Delete Ongoing Research Papers</b></div>
   
   <table cellspacing="0">
      <tr>
      <th>S.No.</th>
      <th>Ongoing Research Paper</th>
         <th>Edit</th>
         <th>Delete</th>
      </tr> ';
$sn=1;
...
echo '<tr><td>'.$sn++.'. </td><td>'.$r.'</td> <td><a href="edit_ongoing_res_here.php?rid='.$rid.'">Edit</a></td><td><a href="del_ongoingr.php?id='.$rid.'">Delete</a></td></tr>';
