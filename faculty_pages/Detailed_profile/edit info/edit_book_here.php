...
<title>Book Publications Edit</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
    <div class="wrapper wrapper--w790">
        <div class="card card-5">
            <div class="card-heading">
                <h2 class="title">EDIT BOOK PUBLICATIONS HERE <i class="fa fa-book" aria-hidden="true"></i></h2>
            </div>
            <div class="card-body">
   ...
   $query ="SELECT * FROM f_books where fid='$idf' and bid='$aid'";
  ...
  <label for="bp"><b>Book publised</b></label>
   
   <?php echo '<input type="text" id="bp" name="bp" value="'.$name.'">'; ?>
   ...
   <?php echo '<input type="text" id="author" name="author" value="'.$author.'">'; ?>


   <label for="link"><b>Link</b></label>
   
   <?php echo '<input type="text" id="link" name="link" value="'.$link.'">'; ?>
...
<?php
				...
				{	
					...
					$query = "UPDATE f_books SET year='$year', bookname='$bp', publisher='$publisher', author='$author', isbn='$isbn', link='$link' where bid='$aid' and fid='$idf'";
			...
			if($roww > 0)
			{
				...
				echo "<script>window.location.href='book_publications_edit.php'</script>";
			}
			else
			{
				//echo "1";
