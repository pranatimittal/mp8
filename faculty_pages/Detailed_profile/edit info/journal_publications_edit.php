...
<title>Edit Journal Publications</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
...
<div class="table-users">
   <div class="heading"><b>Edit / Delete Journal Publications</b></div>
   ...
   $query ="SELECT * FROM f_journal where fid='$idf'";
   ...
   while($row = mysqli_fetch_array($result)) {
      ...
      <td><?php echo $c++; ?> </td>
		 ...
		 <?php echo '<td><a href="edit_journal_here.php?aid='.$aid.'">Edit</a></td>';?>
         <?php echo '<td><a href="del_journal.php?aid='.$aid.'">Delete</a></td>'; ?>
