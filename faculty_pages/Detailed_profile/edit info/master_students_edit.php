...
<title>Edit Master Students</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
...
echo '<div class="table-users">
   <div class="heading"><b>Master Students</b></div>
...
$q11=mysqli_query($con,"SELECT * FROM f_student WHERE fid='$fid' AND type='Masters' " )or die('Error231');
 ...
 while($row11=mysqli_fetch_array($q11))
  {
    ...
    $darr=explode("-",$d);
      ...
      echo '<tr>
         ...
         <td>'.$t.'</td>
         <td>'.$u.'</td>
         <td>'.$darr[2].'/'.$darr[1].'/'.$darr[0].'</td><td><a href="edit_master_here.php?id='.$sid.'">Edit</a></td><td><a href="del_Mstu.php?id='.$sid.'">Delete</a></td></tr>';
  }
