...
<title>Consulting Assignments Edit</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Consulting Assignments</b>
            </span>
<?php
   
   $query ="SELECT * FROM f_cons_ass_funding where fid='$idf' and cons_id='$aid'";
   ...
   ?>
		...
		<?php
				...
				{	
					...
					$query = "UPDATE f_cons_ass_funding SET cons_ass='$mes' where cons_id='$aid' and fid='$idf'";
			...
			if($roww > 0)
			{
				echo "<script>alert('Consulting Assignments fundings edited successfully.')</script>";
