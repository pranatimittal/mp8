...
<div class="contact1">
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit achievements</b>
            </span>
   ...
   $query ="SELECT * FROM f_achievement where fid='$idf' and aid='$aid'";
   ...
   <?php echo '<textarea class="input1" name="achievement" value ='.$val.'>'.$val.'</textarea>'   ?>
   ...
   ?>
		...
		<?php
				...
				{	
					...
					$query = "UPDATE f_achievement SET value='$name'where aid='$aid' and fid='$idf'";
			...
			if($roww > 0)
			{
				...
				echo "<script>window.location.href='achievements_edit.php'</script>";
			}
			else
			{
				//echo "1";
