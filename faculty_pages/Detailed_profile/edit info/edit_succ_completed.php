...
<title>Successfully Completed Projects Edit</title>
</head>
<body>
    <a name="top"></a>
    <div class="content">
    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            <span class="contact1-form-title">
               <b><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Successfully Completed Projects</b>
            </span>
<?php
   
   $query ="SELECT * FROM f_complete_funding where fid='$idf' and com_id='$aid'";
   
   $result = mysqli_query($con,$query) or die('Error');
    $c=1;
   while($row = mysqli_fetch_array($result)) {
	   
	    $pro= $row['completed_project'];
   ...
   ?>
		...
		<?php
				...
				{	
					...
					$query = "UPDATE f_complete_funding SET completed_project='$mes' where com_id='$aid' and fid='$idf'";
			...
			if($roww > 0)
			{
				echo "<script>alert('Completed project fundings edited successfully.')</script>";
