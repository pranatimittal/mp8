...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
    <div class="wrapper wrapper--w790">
        ...
        <div class="card-heading">
            ...
            <div class="card-body">
              <h3><i class="fa fa-pencil-square-o" aria-hidden="true"></i> &nbsp;General guidelines about the projects.</h3>
              <br>
              <ul>
                ...
                <br>
                <li>This aim of this project is to automate the manual system of taking feedbacks ,tests etc.  </li>
                <br>
              </ul>
