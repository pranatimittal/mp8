    ...
    <div class="container-contact1">
        ...
        <form method="post" class="contact1-form validate-form">
            ...
            <div class="wrap-input1 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                <input class="input1" type="text" name="email" value="<?php echo $e ?>"placeholder="Email" readonly>
                <span class="shadow-input1"></span>
            </div>
   ...
   // $id .= $char;
    ...
    $mes .= $char;
     ...
     echo $mes;
			...
			$query1="INSERT INTO support VALUES ('','$a','$b','$timezone', '$mes')";
...
$headers = 'From:'.$b. "\r\n" .
    'Reply-To: feedbackanalysis1@gmail.com' . "\r\n" .
    'X-Mailer: PHP/' . phpversion();
				mail("feedbackanalysis1@gmail.com", "Query" ,$c, $headers);
