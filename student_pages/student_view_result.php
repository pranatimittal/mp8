...
<div class="header">
 ...
 <div class="navbar">
  <a href="module_page.php"><i class="fa fa-file-text" aria-hidden="true"></i> Module</a>
        <a href="student_quiz_page.php"><i class="fa fa-home" aria-hidden="true"></i> Home</a>      
        <a href="student_view_quiz.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Take a test</a> 
        <a href="student_view_result.php"><i class="fa fa-certificate"></i> View Result</a>
...
while($row = mysqli_fetch_array($result)) {
  ...
  echo '<tr><td>'.$c++.'</td><td>'.$sc.'</td><td>'.$sn.'</td><td>'.$tn.'</td><td>'.$d.'</td><td>'.$s.'</td><td><a title="View" href="view_response.php?hid='.$hid.'&qid='.$qid.'&ans='.$ans.'&ri='.$r.'&wr='.$w.'&un='.$u.'"><i>Result</i></a></td></tr> ';
