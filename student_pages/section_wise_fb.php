...
<div class="content">
  ...
  <table align="center">
      ...
      <!-- <tr>
          <th>Delivery of lectures as per syllabus</th>
           <td> <input type="radio" name="del" value="5" > <br></td>
           <td> <input type="radio" name="del" value="4" > <br></td>
         <td> <input type="radio" name="del" value="3" > <br></td>
           <td> <input type="radio" name="del" value="2" > <br></td>
           <td> <input type="radio" name="del" value="1" > <br></td>
         </tr>
         <tr> -->
...
<textarea id="comment" style="height:100px;font-family: Arial, Helvetica, sans-serif; margin-left: 15px; width:400px;background-color:  #eeeae9 ;border:1px solid black; font-size:20px;">
</textarea><br><br>
<button style="width:200px; height:35px; float:right; margin-right:10px; " onclick="location.href = 'student_home_page.php';">
<b>	<a style="font-size:25px; font-family:Times-roman; font-weight: bold;">Cancel</a></b>
     ...
     <b>  <a style="font-size:20px; font-family:Times-roman;">Submit</a> </b>
	  ...
	  --->
	  <input name="sub" id="sub" value = "Submit" style="width:200px; height:35px; float:right;  margin-right:30px; background:#4CAF50;font-size:25px; font-family:Times-roman;" type="submit" onclick="getCheckedRadio();"/>
      <br><br><br>
    ...
    for (var x = 0; x < radioButtons.length; x ++) {
     ...
     //  alert("Value is " + radioButtons[x].value;
	   ...
	   var qua_lec=0;
	      ...
	      var radioButtons = document.getElementsByName("del");
    for (var x = 0; x < radioButtons.length; x ++) {
      if (radioButtons[x].checked) {
        var p=radioButtons[x].value;
     qua_lec+= parseInt(p);
